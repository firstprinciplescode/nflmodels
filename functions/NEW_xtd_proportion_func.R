...
xtd_proportion <- sqldf("SELECT qbgrp_ssn, def_ssn, posteam, defteam, week, season,
              SUM(CASE WHEN play_type == 'pass' AND qb_scramble == 0 THEN after_xtd_new END) AS pbp_pass_xtd,
              SUM(CASE WHEN qb_scramble == 1 THEN after_xtd_new END) AS pbp_qb_scramble_xtd,
              SUM(CASE WHEN play_type == 'run' AND qb_scramble == 0 THEN after_xtd_new END) AS pbp_run_xtd,
              SUM(CASE WHEN play_type == 'pass' AND qb_scramble == 0 THEN part_after_xtd_new END) AS part_pass_xtd,
              SUM(CASE WHEN qb_scramble == 1 THEN part_after_xtd_new END) AS part_qb_scramble_xtd,
              SUM(CASE WHEN play_type == 'run' AND qb_scramble == 0 THEN part_after_xtd_new END) AS part_run_xtd              
      FROM    combined_pbp_info
      GROUP BY  qbgrp_ssn, def_ssn, posteam, defteam, week, season")


xtd_proportion$pbp_pass_xtd[which(is.na(xtd_proportion$pbp_pass_xtd))] <- 0
xtd_proportion$pbp_qb_scramble_xtd[which(is.na(xtd_proportion$pbp_qb_scramble_xtd))] <- 0
xtd_proportion$pbp_run_xtd[which(is.na(xtd_proportion$pbp_run_xtd))] <- 0
xtd_proportion$part_pass_xtd[which(is.na(xtd_proportion$part_pass_xtd))] <- 0
xtd_proportion$part_qb_scramble_xtd[which(is.na(xtd_proportion$part_qb_scramble_xtd))] <- 0
xtd_proportion$part_run_xtd[which(is.na(xtd_proportion$part_run_xtd))] <- 0
...
xtd_proportion$part_pass_prop[which(xtd_proportion$season == 2024)] <- NA
xtd_proportion$part_qb_scramble_prop_rank[which(xtd_proportion$season == 2024)] <- NA
xtd_proportion$part_run_xtd_rank[which(xtd_proportion$season == 2024)] <- NA
xtd_proportion$part_pass_prop_rank_def[which(xtd_proportion$season == 2024)] <- NA
xtd_proportion$part_qb_scramble_prop_rank_def[which(xtd_proportion$season == 2024)] <- NA
xtd_proportion$part_run_xtd_rank_def[which(xtd_proportion$season == 2024)] <- NA
...
xtd_proportion_func('KCMahomes-2024', 'PHI2024')


View(xtd_proportion %>% filter(qbgrp_ssn == "KCMahomes-2024"))
View(xtd_proportion %>% filter(def_ssn == "PHI2024"))
