  ...
  process_category <- function(qbgrp_one, defgrp_one, qb_threshold, def_threshold, qb_func, def_func) {
    ...
    return(rbind(
      qb_stats_df_final %>% 
        ...
        summarise(n = n(), across(c(plays, no_huddle, plays_rank, plays_rank_def, no_huddle_rank, no_huddle_rank_def), mean, na.rm = TRUE)),
...
play_cnt_func('KCMahomes-2024', 'PHI2024')
