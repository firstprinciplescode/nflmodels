  ...
  process_category <- function(qbgrp_one, defgrp_one, qb_threshold, def_threshold, qb_func, def_func) {
    ...
    return(rbind(
      qb_stats_df_final %>% 
        ...
        summarise(n = n(), across(c(sack_rate, pbp_sack_rate, part_sack_rate, pressure_rate,
                                    sack_rate_rank, sack_rate_rank_def,
                                    pbp_sack_rate_rank, pbp_sack_rate_rank_def,
                                    part_sack_rate_rank, part_sack_rate_rank_def,
...
sack_rate_func('KCMahomes-2024', 'PHI2024')
