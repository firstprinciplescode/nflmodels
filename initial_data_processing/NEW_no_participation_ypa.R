...
eta_pbp_pass = .027 # .027
gamma_pbp_pass = 2.25 # 2.25
max_depth_pbp_pass = 4 # 4
min_child_weight_pbp_pass = 5.25 # 5.25
alpha_pbp_pass = .2 # .2
lambda_pbp_pass = .35 # .35
colsample_bynode_pbp_pass = .8 # .8
...
xgb.save(xgb_pbp_pass, 'xgb_pbp_ypa_no_weather.model')
...
sample_split_all_dfs_pass <- sample.split(Y = pbp_nfl_pass_temp$yards_gained, SplitRatio = 0.8)
...
d_xpass_all = pbp_nfl_pass_temp %>% select(-yards_gained)
d_ypass_all = pbp_nfl_pass_temp$yards_gained
d_all_pass_all = xgb.DMatrix(data = as.matrix(d_xpass_all), label = d_ypass_all)
...
gamma_pbp_pass = 0 # 0
max_depth_pbp_pass = 4 # 4
min_child_weight_pbp_pass = 0 # 5.25
alpha_pbp_pass = 0 # 0
lambda_pbp_pass = .5 # .5
colsample_bynode_pbp_pass = .4 # .4
colsample_bylevel_pbp_pass = 1 # 1
colsample_bytree_pbp_pass = 1 # 1
