...
sample_split_all_dfs_pass <- sample.split(Y = xgboost_pbp_nfl$sack, SplitRatio = 0.8)
...
d_xpass_all = xgboost_pbp_nfl %>% select(-sack)
d_ypass_all = xgboost_pbp_nfl$sack
...
xgb.save(xgb_part_pass, 'xgb_pbp_sack_no_weather.model')
...
sample_split_all_dfs_pass <- sample.split(Y = xgboost_pbp_nfl_weather$sack, SplitRatio = 0.8)
...
d_xpass_all = xgboost_pbp_nfl_weather %>% select(-sack)
d_ypass_all = xgboost_pbp_nfl_weather$sack
d_all_pass_all = xgb.DMatrix(data = as.matrix(d_xpass_all), label = d_ypass_all)

watchlist_pass_all_dfs = list(train=dtrain_pass_all_dfs, test=dtest_pass_all_dfs)


eta_part_pass = .071 # .071
gamma_part_pass = 6 # 6
max_depth_part_pass = 5 # 5
min_child_weight_part_pass = 0 # 0
alpha_part_pass = .3 # .3
lambda_part_pass = .75 # .75
colsample_bynode_part_pass = .275 # .275
colsample_bylevel_part_pass = 1 # 1
colsample_bytree_part_pass = 1 # 1
...
xgb.save(xgb_part_pass, 'xgb_pbp_sack_weather.model')
