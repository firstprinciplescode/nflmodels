...
xgboost_part_nfl$sack <- as.factor(xgboost_part_nfl$sack)
...
xgboost_part_nfl$sack <- as.integer(as.factor(xgboost_part_nfl$sack)) - 1
...
eta_part_pass = .02 # .07
gamma_part_pass = 1.329 # 3.75
max_depth_part_pass = 4 # 4
min_child_weight_part_pass = 10.582 # 1
alpha_part_pass = .36 # .3
lambda_part_pass = .539 # 0
colsample_bynode_part_pass = .732 # 1
colsample_bylevel_part_pass = .56 # 1
colsample_bytree_part_pass = .442 # 1
...
xgb.save(xgb_part_pass, 'xgb_part_sack.model')
