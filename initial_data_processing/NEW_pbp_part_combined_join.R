...
combined_info$mixed_xtd <- ifelse(!is.na(combined_info$part_after_xtd_new), .2058 * combined_info$after_xtd_new + .2571 * combined_info$part_after_xtd_new + .1456 * combined_info$part_after_xtd + .1152 * combined_info$after_xtd_new + .1069 * combined_info$part_before_xtd_new + .0493 * combined_info$predicted_before_xtd + .0663 * combined_info$before_xtd_new + .0538 * combined_info$part_before_xtd, (.2058 / (.2058 + .1152 + .0493 + .0663)) * combined_info$after_xtd_new + (.1152 / (.2058 + .1152 + .0493 + .0663)) * combined_info$after_td + (.0486 / (.2058 + .1152 + .0493 + .0663)) * combined_info$predicted_before_xtd + (.0663 / (.2058 + .1152 + .0493 + .0663)) * combined_info$before_xtd_new) 
