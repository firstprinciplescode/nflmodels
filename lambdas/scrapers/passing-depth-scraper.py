...
def scrape_passing_depth_for_week(season, week, auth):
    """
...
def scrape_all_passing_depth(auth, season, weeks):
    ...
    for week in weeks:
        df = scrape_passing_depth_for_week(season, week, auth)
...
def lambda_handler(event, context):
    ...
    try:
        ...
        df = scrape_all_passing_depth(auth, season, weeks)
