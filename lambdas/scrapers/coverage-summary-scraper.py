...
def scrape_coverage_summary(season, week, auth):
    url = f'https://api.pff.com/v1/facet/defense/coverage?league=nfl&season={season}&week={week}'
...
def lambda_handler(event, context):
    try:
        ...
        for idx, week in enumerate(weeks, 1):
            ...
            df = scrape_coverage_summary(season, week, auth)
