...
def scrape_coverage_scheme(season, week, cookies):
    url = f'https://premium.pff.com/api/v1/facet/defense/coverage_scheme?league=nfl&season={season}&week={week}'
...
def lambda_handler(event, context):
    try:
        ...
        for idx, week in enumerate(weeks, 1):
            ...
            df = scrape_coverage_scheme(season, week, cookies)
