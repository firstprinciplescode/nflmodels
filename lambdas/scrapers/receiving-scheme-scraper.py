...
def check_restricted_access(auth):
    ...
    url = f'https://api.pff.com/v1/facet/receiving/scheme?league=nfl&season={test_season}&week={test_week}'
...
def scrape_receiver_scheme_for_week(season, week, auth):
    ...
    """
    url = f'https://api.pff.com/v1/facet/receiving/scheme?league=nfl&season={season}&week={week}'
