...
# CLUSTER 1 - MID USAGE LATER DOWN LONGER YARDAGE
# CLUSTER 2 - LOW USAGE SHORT YARDAGE
# CLUSTER 3 - MID MID MID
# CLUSTER 4 - MID USAGE SHORT YARDAGE
# CLUSTER 5 - ONLY LONG YARDAGE
# CLUSTER 6 - HIGH USAGE LEAN SHORT YARD
# CLUSTER 7 - HIGHEST USAGE
...
# 1 - HIGHER USAGE EARLY DOWN LEAN SHORT YARDAGE
# 2 - ONLY LATE DOWN
# 3 - EARLY DOWN ONLY SHORTER YARDAGE ONLY 
# 4 - MID MID MID
# 5 - EARLY DOWN ONLY
# 6 - LOW USAGE
# 7 - LOWER USAGE BASICALLY 2ND DOWN ONLY
# 8 - ONLY LONG YARDAGE
# 9 - MID USAGE LATE DOWN / SHORT YARDAGE 
...
# 1 - L0WER USAGE SHORTER YARDAGE
# 2 - HIGHER USAGE
# 3 - LONGER YARDAGE MIDDLE DOWNS
# 4 - MID USAGE SHORT YARDAGE
# 5 - HIGHER USAGE MIDDLE DOWNS MIDDLE YARDAGE
# 6 - LOWER USAGE FIRST DOWN
# 7 - ONLY SHORT YARDAGE
# 8 - ONLY EARLIER DOWN LONGER YARDAGE


### FOR THOSE WITH NA CLUSTERS --> WE SHOULD JUST INTERPOLATE WITH 99 --> LOW AF VOLUME


combined_rush_summation_final_a$cluster[which(is.na(combined_rush_summation_final_a$cluster))] <- 99
combined_rush_summation_final_b$cluster[which(is.na(combined_rush_summation_final_b$cluster))] <- 99
combined_rush_summation_final_c$cluster[which(is.na(combined_rush_summation_final_c$cluster))] <- 99


combined_rush_summation_all_rank_grp <- rbind(combined_rush_summation_final_a, combined_rush_summation_final_b, combined_rush_summation_final_c)
