...
weather_play_cnt_func <- function(qbgrp_one, defgrp_one) {
  ...
  selected_columns <- c("plays", "no_huddle", "plays_rank", "plays_rank_def", "no_huddle_rank", "no_huddle_rank_def")
  ...
  sheet_name <- substr(paste0("WeatherPlays - ", qbgrp_one, " vs ", defgrp_one), 1, 31)
  tmp <- tempfile(fileext = ".xlsx")
  saveWorkbook(wb, tmp)
...
weather_play_cnt_func("CARYoung-2025", "LA2025")

precip_play_cnt_func <- function(qbgrp_one, defgrp_one) {
  ...
  sheet_name <- substr(paste0("PrecipPlays - ", qbgrp_one, " vs ", defgrp_one), 1, 31)
  tmp <- tempfile(fileext = ".xlsx")
  saveWorkbook(wb, tmp)
  put_object(tmp, bucket = bucket, object = paste0("outputs/", sheet_name, ".xlsx"))
...
precip_play_cnt_func("CARYoung-2025", "LA2025")
