...
comparison_blitz_func("NEMaye-2025", .98) # 73
comparison_depth_func("NEMaye-2025", .95) # 98
comparison_less_func("NEMaye-2025", .98) # 75
comparison_pa_func("NEMaye-2025", 1.01) # 61
comparison_pressure_func("NEMaye-2025", 1.012) # 51

comparison_blitz_def_func("SEA2025", .985) # 70
comparison_depth_def_func("SEA2025", 1.085) # 31
comparison_less_def_func("SEA2025", 1.01) # 58
comparison_pa_def_func("SEA2025", 1.025) # 46
comparison_pressure_def_func("SEA2025", .99) # 68
...
weather_xtds_func <- function(qbgrp_one, defgrp_one) {
  ...
  categories <- list(
    blitz = list(
      qb_threshold = .98, def_threshold = .985,
      qb_func = comparison_blitz_func, def_func = comparison_blitz_def_func,
    ...
    depth = list(
      qb_threshold = .95, def_threshold = 1.085,
      qb_func = comparison_depth_func, def_func = comparison_depth_def_func,
      columns = c("tds", "fgs", "pbp_xtds", "part_xtds", 
    ...
    less = list(
      qb_threshold = .98, def_threshold = 1.01,
      qb_func = comparison_less_func, def_func = comparison_less_def_func,
      columns = c("tds", "fgs", "pbp_xtds", "part_xtds", 
                  "pbp_xtds_rank", "part_xtds_rank",
                  "ypa", "pbp_xypa", "part_xypa", 
    ...
    pa = list(
      qb_threshold = 1.01, def_threshold = 1.025,
      qb_func = comparison_pa_func, def_func = comparison_pa_def_func,
      columns = c("tds", "fgs", "pbp_xtds", "part_xtds", 
                  "pbp_xtds_rank", "part_xtds_rank",
                  "ypa", "pbp_xypa", "part_xypa", 
    ...
    pressure = list(
      qb_threshold = 1.012, def_threshold = .99,
      qb_func = comparison_pressure_func, def_func = comparison_pressure_def_func,
      columns = c("tds", "fgs", "pbp_xtds", "part_xtds", 
                  "pbp_xtds_rank", "part_xtds_rank",
                  "ypa", "pbp_xypa", "part_xypa", 
...
comparison_blitz_func("DALPrescott-2025", .957) # 89
comparison_depth_func("DALPrescott-2025", .95) # 96
comparison_less_func("DALPrescott-2025", .93) # 106
comparison_pa_func("DALPrescott-2025", .925) # 112
comparison_pressure_func("DALPrescott-2025", .925) # 111
...
comparison_blitz_func("TENTannehill-2019", 1.065) # 32
comparison_depth_func("TENTannehill-2019", 1.07) # 29
comparison_less_func("TENTannehill-2019", .99) # 77
comparison_pa_func("TENTannehill-2019", .978) # 88
comparison_pressure_func("TENTannehill-2019", 1.065) # 30
...
comparison_blitz_def_func("SEA2024", .953) # 96
comparison_depth_def_func("SEA2024", 1.05) # 30
comparison_less_def_func("SEA2024", .945) # 103
comparison_pa_def_func("SEA2024", .996) # 66
comparison_pressure_def_func("SEA2024", .997) # 65
