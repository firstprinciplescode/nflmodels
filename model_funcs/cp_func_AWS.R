...
weather_cp_func <- function(qbgrp_one, defgrp_one) {
  ...
  selected_columns <- c("acc_rate", "fastr_cp", "pbp_cp", "part_cp", 
  ...
  sheet_name <- substr(paste0("WeatherCP - ", qbgrp_one, " vs ", defgrp_one), 1, 31)
  tmp <- tempfile(fileext = ".xlsx")
  saveWorkbook(wb, tmp)
...
weather_cp_func("CARYoung-2025", "LA2025")

precip_cp_func <- function(qbgrp_one, defgrp_one) {
  ...
  sheet_name <- substr(paste0("PrecipCP - ", qbgrp_one, " vs ", defgrp_one), 1, 31)
  tmp <- tempfile(fileext = ".xlsx")
  saveWorkbook(wb, tmp)
  put_object(tmp, bucket = bucket, object = paste0("outputs/", sheet_name, ".xlsx"))
...
precip_cp_func("CARYoung-2025", "LA2025")
