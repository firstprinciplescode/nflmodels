...
query_blitz <- query_blitz %>% arrange(def_ssn, week, season)

# ============================================================================
# FAST LEAVE-ONE-OUT (replaces the slow for loop)
# ============================================================================
...
xtd_blitz_df <- map_dfr(1:nrow(query_blitz), function(i) {
...
cat("\nCOMPLETE - Created", nrow(xtd_blitz_df), "game feature rows\n")
...
# Test it
comparison_blitz_def_func("PHI2025", .9)
...
save.image("~/df_blitz_def_build_workspace_AWS.RData")