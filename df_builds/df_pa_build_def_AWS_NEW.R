# ============================================================================
# PA (PLAY ACTION) DEFENSE BUILD - FAST VERSION
# ============================================================================
...
query_pa <- query_pa %>% arrange(def_ssn, week, season)
...
# Test it
comparison_pa_def_func("PHI2025", 1)

# Save dependencies
list_dependencies_pa_def <- list(
  df_pa_def_scaled_z = df_pa_def_scaled_z,
  importance_matrix_pa_def = importance_matrix_pa_def
)

save(list_dependencies_pa_def, file = "list_dependencies_pa_def.RData")
put_object(
  file = "list_dependencies_pa_def.RData",
  object = "def_functions/list_dependencies_pa_def.RData",
  bucket = "nfl-pff-data-lucas"
)

save(comparison_pa_def_func, file = "comparison_pa_def_func.rds")
put_object(
  file = "comparison_pa_def_func.rds",
  object = "def_functions/comparison_pa_def_func.rds",
  bucket = "nfl-pff-data-lucas"
)

save.image("~/df_pa_def_build_workspace_AWS.RData")
